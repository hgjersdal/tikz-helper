...
\pgfpointadd{\pgfpointxy {-7.0} {-1.2}} {\pgfpoint{0}{-0.15cm}}\pgfpathmoveto{ NIL }
\pgfpointadd{\pgfpointxy {7.0} {-1.2}} {\pgfpoint{0}{-0.15cm}}\pgfpathlineto{ NIL }
\pgfpointadd{\pgfpointxy {-7.0} {-1.2}} {\pgfpoint{-0.15cm}{0}}\pgfpathmoveto{ NIL }
\pgfpointadd{\pgfpointxy {-7.0} {1.2}} {\pgfpoint{-0.15cm}{0}}\pgfpathlineto{ NIL }
\pgfusepath{ stroke, }
\end{scope}
...
\begin{scope}[shift={(7.0,1.2)}]
\begin{scope}[yshift=-0.15cm]
\draw[black] [shift={(-6.283185307179586,-1.2)}] (0,0) -- (0,-2pt) node[below]{ \scriptsize{$-2\pi$}};
\draw[black] [shift={(-3.141592653589793,-1.2)}] (0,0) -- (0,-2pt) node[below]{ \scriptsize{$-\pi$}};
\draw[black] [shift={(0.0,-1.2)}] (0,0) -- (0,-2pt) node[below]{ \scriptsize{0.0}};
\draw[black] [shift={(3.141592653589793,-1.2)}] (0,0) -- (0,-2pt) node[below]{ \scriptsize{$\pi$}};
\draw[black] [shift={(6.283185307179586,-1.2)}] (0,0) -- (0,-2pt) node[below]{ \scriptsize{$2\pi$}};
\end{scope}
\end{scope}
...
\end{scope}
\end{scope}
\draw[red] (0.5,5.2) -- (0.9,5.2);
\node at (0.9,5.2) [right,,] {sin(x)};
\draw[blue] (2.5,5.2) -- (2.9,5.2);
\node at (2.9,5.2) [right,,] {cos(x)};
\end{tikzpicture}
\end{document}
