...
\pgfsetyvec{\pgfpoint{0cm}{2.0833333333333335cm}}
...
\end{scope}
\end{scope}
\draw[red] (0.7,5.3) -- (1.1,5.3);
\draw[opacity=0.0,white] (0.7,5.4) -- (0.7,5.2);
\node at (1.1,5.3) [right,] {sin(x)};
\begin{scope}[]
\pgfpathmoveto{ \pgfpointadd{\pgfpointxy {0.0} {0.0}} {\pgfpoint{0cm}{0cm}} }
\pgfpathlineto{ \pgfpointadd{\pgfpointxy {0.0} {0.0}} {\pgfpoint{10cm}{0cm}} }
\pgfpathlineto{ \pgfpointadd{\pgfpointxy {0.0} {0.0}} {\pgfpoint{10cm}{5cm}} }
...
\end{scope}
\end{scope}
\draw[blue] (2.9,5.3) -- (3.3,5.3);
\draw[opacity=0.0,white] (2.9,5.4) -- (2.9,5.2);
\node at (3.3,5.3) [right,] {cos(x)};
\end{tikzpicture}
\end{document}
