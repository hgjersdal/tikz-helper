...
\draw[thin,gray] [shift={(-6.283185307179586,-1.2)}] (0,5cm) -- (0,0cm) node[below]{ \scriptsize{}};
\draw[thin,gray] [shift={(-3.141592653589793,-1.2)}] (0,5cm) -- (0,0cm) node[below]{ \scriptsize{}};
\draw[thin,gray] [shift={(3.141592653589793,-1.2)}] (0,5cm) -- (0,0cm) node[below]{ \scriptsize{}};
\draw[thin,gray] [shift={(6.283185307179586,-1.2)}] (0,5cm) -- (0,0cm) node[below]{ \scriptsize{}};
\end{scope}
\begin{scope}[xshift=0cm]
\draw[thin,gray] [shift={(-7.0,-1.0)}] (10cm,0) -- (0cm,0) node[left]{ \scriptsize{}};
\draw[thin,gray] [shift={(-7.0,-0.5)}] (10cm,0) -- (0cm,0) node[left]{ \scriptsize{}};
\draw[thin,gray] [shift={(-7.0,0.5)}] (10cm,0) -- (0cm,0) node[left]{ \scriptsize{}};
\draw[thin,gray] [shift={(-7.0,1.0)}] (10cm,0) -- (0cm,0) node[left]{ \scriptsize{}};
\end{scope}
\begin{scope}[yshift=2.5cm]
\draw[black] [shift={(-6.283185307179586,-1.2)}] (0,0) -- (0,0) node[below]{ \scriptsize{$-2\pi$}};
\draw[black] [shift={(-3.141592653589793,-1.2)}] (0,0) -- (0,0) node[below]{ \scriptsize{$-\pi$}};
\draw[black] [shift={(3.141592653589793,-1.2)}] (0,0) -- (0,0) node[below]{ \scriptsize{$\pi$}};
\draw[black] [shift={(6.283185307179586,-1.2)}] (0,0) -- (0,0) node[below]{ \scriptsize{$2\pi$}};
\end{scope}
\begin{scope}[xshift=5cm]
\draw[black] [shift={(-7.0,-1.0)}] (0,0) -- (0,0) node[left]{ \scriptsize{\num[round-mode=places,round-precision=1]{-1.0}}};
\draw[black] [shift={(-7.0,-0.5)}] (0,0) -- (0,0) node[left]{ \scriptsize{\num[round-mode=places,round-precision=1]{-0.5}}};
\draw[black] [shift={(-7.0,0.5)}] (0,0) -- (0,0) node[left]{ \scriptsize{\num[round-mode=places,round-precision=1]{0.5}}};
\draw[black] [shift={(-7.0,1.0)}] (0,0) -- (0,0) node[left]{ \scriptsize{\num[round-mode=places,round-precision=1]{1.0}}};
\end{scope}
\begin{scope}[red]
