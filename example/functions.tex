...
\draw[ultra thin,gray] [shift={(-7.0,-1.0)}] (5cm,0) -- (-5cm,0) node[black,midway,left]{ \scriptsize{\num[round-mode=places,round-precision=1]{-1.0}}};
\draw[ultra thin,gray] [shift={(-7.0,-0.5)}] (5cm,0) -- (-5cm,0) node[black,midway,left]{ \scriptsize{\num[round-mode=places,round-precision=1]{-0.5}}};
\draw[ultra thin,gray] [shift={(-7.0,0.5)}] (5cm,0) -- (-5cm,0) node[black,midway,left]{ \scriptsize{\num[round-mode=places,round-precision=1]{0.5}}};
\draw[ultra thin,gray] [shift={(-7.0,1.0)}] (5cm,0) -- (-5cm,0) node[black,midway,left]{ \scriptsize{\num[round-mode=places,round-precision=1]{1.0}}};
\end{scope}
\begin{scope}[red]
