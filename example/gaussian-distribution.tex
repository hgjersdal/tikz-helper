...
\end{scope}
\end{scope}
\node at (-2.5,0.05546041322884499) [fill=white,opacity=0.3,draw=black, rounded corners,rectangle,inner sep=2.0pt,minimum width =2.0pt,minimum height=2.0pt] {2.2\%};
\node at (-2.5,0.05546041322884499) [text=black,rectangle,inner sep=0.0pt,minimum width =2.0pt,minimum height=2.0pt] {2.2\%};
\end{scope}
...
\end{scope}
\end{scope}
\node at (-1.5,0.04702453752886658) [fill=white,opacity=0.3,draw=black, rounded corners,rectangle,inner sep=2.0pt,minimum width =2.0pt,minimum height=2.0pt] {13.6\%};
\node at (-1.5,0.04702453752886658) [text=black,rectangle,inner sep=0.0pt,minimum width =2.0pt,minimum height=2.0pt] {13.6\%};
\end{scope}
\pgfsetxvec{\pgfpoint{1cm}{0cm}}
\pgfsetyvec{\pgfpoint{0cm}{1cm}}
\end{scope}
...
\end{scope}
\end{scope}
\node at (-0.5,0.17603266155126776) [fill=white,opacity=0.3,draw=black, rounded corners,rectangle,inner sep=2.0pt,minimum width =2.0pt,minimum height=2.0pt] {34.1\%};
\node at (-0.5,0.17603266155126776) [text=black,rectangle,inner sep=0.0pt,minimum width =2.0pt,minimum height=2.0pt] {34.1\%};
\end{scope}
\pgfsetxvec{\pgfpoint{1cm}{0cm}}
\pgfsetyvec{\pgfpoint{0cm}{1cm}}
\end{scope}
...
\pgfpathlineto{ \pgfpointxy {3.2} {0.0}}
\pgfpathmoveto{ \pgfpointxy {0.0} {0.0}}
\pgfpathlineto{ \pgfpointxy {0.0} {0.45}}
\pgfusepath{ stroke, }
\end{scope}
