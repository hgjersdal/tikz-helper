...
\pgfusepath{ stroke, fill, }
\end{scope}
\begin{scope}[draw=black,ultra thin, fill=blue!59!DarkBlue]
...
\pgfusepath{ stroke, fill, }
\end{scope}
\begin{scope}[draw=black,ultra thin, fill=blue!91!DarkBlue]
...
\pgfusepath{ stroke, fill, }
\end{scope}
\begin{scope}[draw=black,ultra thin, fill=red!87!orange]
...
\pgfusepath{ stroke, fill, }
\end{scope}
\begin{scope}[draw=black,ultra thin, fill=red!75!orange]
...
\pgfsetyvec{\pgfpoint{0cm}{0.002528700753552825cm}}
\begin{scope}[shift={(0.0,0.0)}]
\begin{scope}[thick,black,fill=white]
\pgfpathmoveto{ \pgfpointxy {0.0} {0.0}}
\pgfpathlineto{ \pgfpointxy {1.0} {0.0}}
\pgfpathlineto{ \pgfpointxy {1.0} {1977.3}}
\pgfpathlineto{ \pgfpointxy {0.0} {1977.3}}
\pgfpathclose
\pgfusepath{ stroke, }
\end{scope}
